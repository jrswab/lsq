...
- skip non-Markdown files in Phase 3
...
- only `--backend file` is accepted in Phase 3 for `simple`
...
- note that Phase 3 is Markdown-only and local-file-backed
- explicit exclusions:
  - no `{{query ...}}`
